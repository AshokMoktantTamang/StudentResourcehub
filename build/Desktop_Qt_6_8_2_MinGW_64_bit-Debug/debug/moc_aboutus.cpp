...
namespace {
struct qt_meta_tag_ZN7AboutusE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN7AboutusE = QtMocHelpers::stringData(
    "Aboutus",
...
Q_CONSTINIT static const uint qt_meta_data_ZN7AboutusE[] = {
...
Q_CONSTINIT const QMetaObject Aboutus::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7AboutusE.offsetsAndSizes,
    qt_meta_data_ZN7AboutusE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7AboutusE_t,
        // Q_OBJECT / Q_GADGET
...
void *Aboutus::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7AboutusE.stringdata0))
